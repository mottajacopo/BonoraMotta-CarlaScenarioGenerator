...
class Scenario(ScenarioGenerator):
    ...
    def scenario(self,**kwargs):
        ...
        if(kwargs['randomPosition']):
            targetstart, egostart, npc_spawns = util.get_random_spawn_points(kwargs['initialOffset'],kwargs['check_lane'])
        else:
            #put a default position here
            print("default position not setted")
            exit

            targetstart = util.shift_lane(targetstart,kwargs['check_lane'])
